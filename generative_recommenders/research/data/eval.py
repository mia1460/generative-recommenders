...
def eval_metrics_v2_from_tensors(
    ...
    # print(f"shared_input_embeddings: 1. True? {shared_input_embeddings[0].equal(shared_input_embeddings[1])}\n2. [0] is {shared_input_embeddings[0]}, [1] is {shared_input_embeddings[1]}")
